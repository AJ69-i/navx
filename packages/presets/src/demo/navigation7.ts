/**
 * Demo content for legacy variant "navigation7" — the catalogue's own words.
 *
...
import { plainBrandSearch } from '../catalogue.js';
import type { NavxContent, NavxPreset } from '../types.js';

/** The chrome this content was written for. */
export const preset: NavxPreset = plainBrandSearch;
