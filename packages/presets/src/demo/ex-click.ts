/**
 * Demo content for legacy variant "ex-click" — the catalogue's own words.
 *
...
import { justifiedLogoSocialDualSpacedClick } from '../catalogue.js';
import type { NavxContent, NavxPreset } from '../types.js';

/** The chrome this content was written for. */
export const preset: NavxPreset = justifiedLogoSocialDualSpacedClick;
...
export const content: NavxContent = {
  ...
  closeGlyph: '✕',
  assetBase: '/legacy/Examples/click_files/',
};
